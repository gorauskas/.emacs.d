...
(defface powerline-active1 '((t (:background "grey11" :inherit mode-line)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-active2 '((t (:background "grey20" :inherit mode-line)))
  "Powerline face 2."
  :group 'powerline)

(defface powerline-inactive1
  '((t (:background "grey5" :foreground "grey40" :inherit mode-line-inactive)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-inactive2
  '((t (:background "grey10" :foreground "grey40" :inherit mode-line-inactive)))
  "Powerline face 2."
  :group 'powerline)
