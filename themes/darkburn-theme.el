...
;; Copyright (C) 2011, 2012, 2013 Bozhidar Batsov
;; Copiright (C) 2013 Jonas Gorauskas
...
;; Version: 1.1
;; Small color alterations to make BG darker and provide a little more
;;   contrast. Changes are marked with the initials JGG below. Renamed
;;   the theme to darkburn.
...
;;; Code:
(deftheme darkburn "The darker version of the Zenburn color theme")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;;; basic coloring
   `(default ((t (:foreground ,zenburn-fg :background ,zenburn-bg-2))))                             ;; JGG
   ...
   `(menu ((t (:foreground ,zenburn-fg :background ,zenburn-bg-2))))                                ;; JGG
   ...
   `(mode-line-inactive
     ((t (:foreground ,zenburn-green-1
                      ...
                      :box (:line-width -1 :style released-button)))))
   `(region ((,class (:background ,zenburn-green-2))))                                              ;; JGG
   ...
   `(font-lock-comment-face ((t (:foreground ,zenburn-green :italic t))))                           ;; JGG
   ...
   `(popup-isearch-match ((t (:background ,zenburn-bg-2 :foreground ,zenburn-fg))))                 ;; JGG
   ...
   `(diff-header ((,class (:background ,zenburn-bg+2))
                  (t (:background ,zenburn-fg :foreground ,zenburn-bg-2))))                         ;; JGG
   `(diff-file-header
     ((,class (:background ,zenburn-bg+2 :foreground ,zenburn-fg :bold t))
      (t (:background ,zenburn-fg :foreground ,zenburn-bg-2 :bold t))))                             ;; JGG

   ;; ert
   `(ert-test-result-expected ((t (:foreground ,zenburn-green+4 :background ,zenburn-bg-2))))       ;; JGG
   `(ert-test-result-unexpected ((t (:foreground ,zenburn-red :background ,zenburn-bg-2))))         ;; JGG
   ...
   `(erc-prompt-face ((t (:foreground ,zenburn-orange :background ,zenburn-bg-2 :weight bold))))    ;; JGG
   ...
   `(gnus-x ((t (:background ,zenburn-fg :foreground ,zenburn-bg-2))))                              ;; JGG

   ;; helm
   `(helm-header
     ((t (:foreground ,zenburn-green
                      :background ,zenburn-bg-2                                                     ;; JGG
                      :underline nil
                      :box nil))))
   `(helm-source-header
   ...
   `(helm-visible-mark ((t (:foreground ,zenburn-bg-2 :background ,zenburn-yellow-2))))             ;; JGG
   ...
   ;; linum-mode
   `(linum ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-2))))                          ;; JGG
   ...
   ;; mic-paren
   `(paren-face-match ((t (:foreground ,zenburn-cyan :background ,zenburn-bg-2 :weight bold))))     ;; JGG
   `(paren-face-mismatch ((t (:foreground ,zenburn-bg-2 :background ,zenburn-magenta :weight bold))))  ;; JGG
   `(paren-face-no-match ((t (:foreground ,zenburn-bg-2 :background ,zenburn-red :weight bold))))   ;; JGG
   ...
   ;; show-paren
   `(show-paren-mismatch ((t (:foreground ,zenburn-red-3 :background ,zenburn-bg-2 :weight bold)))) ;; JGG
   `(show-paren-match ((t (:foreground ,zenburn-blue-1 :background ,zenburn-bg-2 :weight bold))))   ;; JGG
   ...
   `(w3m-lnum ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-2))))                       ;; JGG
   ...
   `(whitespace-line ((t (:background ,zenburn-bg-2 :foreground ,zenburn-magenta))))                ;; JGG
  ...
  (custom-theme-set-variables
   'darkburn
   `(ansi-color-names-vector [,zenburn-bg-2 ,zenburn-red ,zenburn-green ,zenburn-yellow             ;; JGG
                                          ,zenburn-blue ,zenburn-magenta ,zenburn-cyan ,zenburn-fg])
   `(ansi-term-color-vector [,zenburn-bg-2 ,zenburn-red ,zenburn-green ,zenburn-yellow              ;; JGG
                                         ,zenburn-blue ,zenburn-magenta ,zenburn-cyan ,zenburn-fg])
